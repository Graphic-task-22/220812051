...
import mount from './sprite/mount';
import { updatePosition } from './sprite/mount';
import tunnel from './mash/tunnel';
import lathe from './mash/lathe';
import tube from './mash/tube';
//import mesh from './mash/buffer';
//import shpark from './mash/shape';
import mesh from'./mash/pigpig';
...
function animate() {
  ...
  updatePosition();     // ⭐️ 关键：每帧更新 geometry 的顶点高度
